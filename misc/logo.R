...
# Load vip image
img <- rasterGrob(readPNG("misc/earth.png"), interpolate = TRUE, width = 1)
...
g <- ggplot() +
  ...
  annotate(geom = "text", x = 0, y = 0, color = greys[1L], size = 4,
...
png("misc/logo.png", width = 181, height = 209, bg = "transparent", 
    type = "cairo-png")
print(g)
dev.off()

svg("misc/logo.svg", width = 181 / 72, height = 209 / 72, bg = "transparent")
print(g)
dev.off()
